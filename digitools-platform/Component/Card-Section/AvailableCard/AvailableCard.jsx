...
const AvailableCard = ({datas}) => {
    ...
    return (
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-11 w-full sm:w-9/12 mx-auto justify-center'>
            ...
            {
                datas.map(data =>{
                    return          <div className="card mx-auto w-80 sm:w-80 md:w-96 bg-base-100 shadow-md rounded-4xl">
...
>
  {data.tag}
    ...
    <span className="text-2xl"><span className="font-bold">${data.price}</span>/mo</span>
